...
require (
	...
	github.com/stader-labs/ethcli-ui/configuration v0.0.0-20231010130550-964eff2070d5
	github.com/stader-labs/ethcli-ui/wizard v0.0.0-20231010130550-964eff2070d5
