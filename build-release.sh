...
build_daemon() {
    ...
    #docker buildx build --platform=linux/arm64 -t staderdev/stader-node:$VERSION-arm64 -f docker/stdr-dockerfile --load . || fail "Error building arm64 Docker Smartnode image."
    echo "done!"
