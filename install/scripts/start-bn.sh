#!/bin/sh
# This script launches ETH2 beacon clients for Stader docker stack; only edit if you know what you're doing ;)
...
if [ "$CC_CLIENT" = "teku" ]; then
    ...
    CMD="$PERF_PREFIX /opt/teku/bin/teku \
        ...
        --validators-proposer-default-fee-recipient=$ETHX_ADDRESS \
        $BN_ADDITIONAL_FLAGS"
