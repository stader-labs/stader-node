...
# It is run in Native Mode only when the Stader node needs to restart your Validator Client (for example, to load new validator keys).
# It is not used in standard (docker-based) Stader setups.
