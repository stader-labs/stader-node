...
func getStatus(c *cli.Context) error {
	...
	fmt.Printf("%s=== Node Registration Info ===%s\n", colorGreen, colorReset)
	if status.Registered {
		...
		fmt.Printf("The node is not registered with Stader. Please use the %snode register%s command to register with stader", colorGreen, colorReset)
	}
