...
func configureService(c *cli.Context) error {
	...
	if md.ShouldSave {
		...
		if md.ChangeNetworks {
			...
			if !cliutils.Confirm("Would you like the Stadernode to automatically switch networks for you? This will destroy and rebuild your `data` folder and all of Docker containers.") {
				return nil
			}
