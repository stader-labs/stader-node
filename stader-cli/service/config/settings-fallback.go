...
func NewFallbackConfigPage(home *settingsHome) *FallbackConfigPage {
	...
	configPage.page = newPage(
		...
		"settings-fallback",
		"Fallback Clients",
		"Select this to manage a separate pair of externally-managed Execution and Consensus clients that the Stader Node and Validator Client will use if your main Execution or Consensus clients ever go offline.",
