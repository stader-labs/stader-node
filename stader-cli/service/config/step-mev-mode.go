...
func createMevModeStep(wiz *wizard, currentStep int, totalSteps int) *choiceWizardStep {
	...
	helperText := "By default, your Stader Node has MEV-Boost enabled. This allows you to capture extra profits from block proposals. Would you like Stader to manage MEV-Boost for you, or would you like to manage it yourself?\n\n"
