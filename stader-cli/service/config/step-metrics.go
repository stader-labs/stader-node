...
func createMetricsStep(wiz *wizard, currentStep int, totalSteps int) *choiceWizardStep {
	...
	helperText := "Would you like to enable the Smartnode's metrics monitoring system? This will monitor things such as hardware stats (CPU usage, RAM usage, free disk space), your minipool stats, stats about your node such as ETH rewards, and much more.\n\nNone of this information will be sent to any remote servers for collection an analysis; this is purely for your own usage on your node."
