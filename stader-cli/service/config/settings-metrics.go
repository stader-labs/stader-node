...
type MetricsConfigPage struct {
	...
	guardianMetricsPortBox     *parameterizedFormItem
...
func NewMetricsConfigPage(home *settingsHome) *MetricsConfigPage {
	...
	configPage.page = newPage(
		...
		"settings-metrics",
		"Monitoring / Metrics",
		"Select this to configure the monitoring and statistics gathering parts of the Stader Node, such as Grafana and Prometheus.",
...
func (configPage *MetricsConfigPage) createContent() {
	...
	configPage.guardianMetricsPortBox = createParameterizedUint16Field(&configPage.masterConfig.GuardianMetricsPort)
	...
	configPage.layout.mapParameterizedFormItems(configPage.enableMetricsBox, configPage.enableOdaoMetricsBox, configPage.ecMetricsPortBox, configPage.bnMetricsPortBox, configPage.vcMetricsPortBox, configPage.nodeMetricsPortBox, configPage.exporterMetricsPortBox, configPage.guardianMetricsPortBox)
...
func (configPage *MetricsConfigPage) handleLayoutChanged() {
	...
	if configPage.masterConfig.EnableMetrics.Value == true {
		configPage.layout.addFormItems([]*parameterizedFormItem{configPage.enableOdaoMetricsBox, configPage.ecMetricsPortBox, configPage.bnMetricsPortBox, configPage.vcMetricsPortBox, configPage.nodeMetricsPortBox, configPage.exporterMetricsPortBox, configPage.guardianMetricsPortBox})
