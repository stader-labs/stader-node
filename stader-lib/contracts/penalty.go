...
//
// Solidity: event UpdatedAdditionalPenaltyAmount(bytes indexed pubkey, uint256 amount)
func (_PenaltyTracker *PenaltyTrackerFilterer) FilterUpdatedAdditionalPenaltyAmount(opts *bind.FilterOpts, pubkey [][]byte) (*PenaltyTrackerUpdatedAdditionalPenaltyAmountIterator, error) {
	...
	logs, sub, err := _PenaltyTracker.contract.FilterLogs(opts, "UpdatedAdditionalPenaltyAmount", pubkeyRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event UpdatedAdditionalPenaltyAmount(bytes indexed pubkey, uint256 amount)
func (_PenaltyTracker *PenaltyTrackerFilterer) WatchUpdatedAdditionalPenaltyAmount(opts *bind.WatchOpts, sink chan<- *PenaltyTrackerUpdatedAdditionalPenaltyAmount, pubkey [][]byte) (event.Subscription, error) {
	...
	logs, sub, err := _PenaltyTracker.contract.WatchLogs(opts, "UpdatedAdditionalPenaltyAmount", pubkeyRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
