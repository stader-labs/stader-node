...
func (_PermissionlessNodeRegistry *PermissionlessNodeRegistryTransactor) AddValidatorKeysWithUtilizeSD(opts *bind.TransactOpts, _referralId string, _amountOfSDToUtilize *big.Int, _pubkey [][]byte, _preDepositSignature [][]byte, _depositSignature [][]byte) (*types.Transaction, error) {
	return _PermissionlessNodeRegistry.contract.Transact(opts, "addValidatorKeysWithUtilizeSD", _referralId, _amountOfSDToUtilize, _pubkey, _preDepositSignature, _depositSignature)
}
...
func (_PermissionlessNodeRegistry *PermissionlessNodeRegistrySession) AddValidatorKeysWithUtilizeSD(_referralId string, _amountOfSDToUtilize *big.Int, _pubkey [][]byte, _preDepositSignature [][]byte, _depositSignature [][]byte) (*types.Transaction, error) {
	return _PermissionlessNodeRegistry.Contract.AddValidatorKeysWithUtilizeSD(&_PermissionlessNodeRegistry.TransactOpts, _referralId, _amountOfSDToUtilize, _pubkey, _preDepositSignature, _depositSignature)
}
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *PermissionlessNodeRegistryValidatorAddedViaReferralIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(PermissionlessNodeRegistryValidatorAddedViaReferral)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *PermissionlessNodeRegistryValidatorAddedViaReferralIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *PermissionlessNodeRegistryValidatorAddedViaReferralIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}
...
func (_PermissionlessNodeRegistry *PermissionlessNodeRegistryFilterer) FilterValidatorAddedViaReferral(opts *bind.FilterOpts) (*PermissionlessNodeRegistryValidatorAddedViaReferralIterator, error) {
	...
	logs, sub, err := _PermissionlessNodeRegistry.contract.FilterLogs(opts, "ValidatorAddedViaReferral")
	if err != nil {
		return nil, err
	}
	return &PermissionlessNodeRegistryValidatorAddedViaReferralIterator{contract: _PermissionlessNodeRegistry.contract, event: "ValidatorAddedViaReferral", logs: logs, sub: sub}, nil
}
...
func (_PermissionlessNodeRegistry *PermissionlessNodeRegistryFilterer) WatchValidatorAddedViaReferral(opts *bind.WatchOpts, sink chan<- *PermissionlessNodeRegistryValidatorAddedViaReferral) (event.Subscription, error) {
	...
	logs, sub, err := _PermissionlessNodeRegistry.contract.WatchLogs(opts, "ValidatorAddedViaReferral")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(PermissionlessNodeRegistryValidatorAddedViaReferral)
				if err := _PermissionlessNodeRegistry.contract.UnpackLog(event, "ValidatorAddedViaReferral", log); err != nil {
					return err
				}
				event.Raw = log
