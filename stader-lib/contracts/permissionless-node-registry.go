...
//
// Solidity: function getAllActiveValidators() view returns((uint8,bytes,bytes,address,uint256,uint256,uint256,uint256)[])
...
//
// Solidity: function getOperatorTotalNonWithdrawnKeys(address _nodeOperator, uint256 startIndex, uint256 endIndex) view returns(uint64)
func (_PermissionlessNodeRegistry *PermissionlessNodeRegistryCaller) GetOperatorTotalNonWithdrawnKeys(opts *bind.CallOpts, _nodeOperator common.Address, startIndex *big.Int, endIndex *big.Int) (uint64, error) {
	var out []interface{}
...
//
// Solidity: function getOperatorTotalNonWithdrawnKeys(address _nodeOperator, uint256 startIndex, uint256 endIndex) view returns(uint64)
func (_PermissionlessNodeRegistry *PermissionlessNodeRegistrySession) GetOperatorTotalNonWithdrawnKeys(_nodeOperator common.Address, startIndex *big.Int, endIndex *big.Int) (uint64, error) {
...
//
// Solidity: function getOperatorTotalNonWithdrawnKeys(address _nodeOperator, uint256 startIndex, uint256 endIndex) view returns(uint64)
func (_PermissionlessNodeRegistry *PermissionlessNodeRegistryCallerSession) GetOperatorTotalNonWithdrawnKeys(_nodeOperator common.Address, startIndex *big.Int, endIndex *big.Int) (uint64, error) {
	return _PermissionlessNodeRegistry.Contract.GetOperatorTotalNonWithdrawnKeys(&_PermissionlessNodeRegistry.CallOpts, _nodeOperator, startIndex, endIndex)
}
...
//
// Solidity: function getValidator(bytes _pubkey) view returns((uint8,bytes,bytes,address,uint256,uint256,uint256,uint256))
...
//
// Solidity: function getValidator(uint256 _validatorId) view returns((uint8,bytes,bytes,address,uint256,uint256,uint256,uint256))
...
//
// Solidity: function validatorRegistry(uint256 ) view returns(uint8 status, bytes pubkey, bytes _signature, address withdrawVaultAddress, uint256 operatorId, uint256 initialBondEth, uint256 depositTime, uint256 withdrawnTime)
func (_PermissionlessNodeRegistry *PermissionlessNodeRegistryCaller) ValidatorRegistry(opts *bind.CallOpts, arg0 *big.Int) (struct {
	...
	outstruct.WithdrawVaultAddress = *abi.ConvertType(out[3], new(common.Address)).(*common.Address)
	outstruct.OperatorId = *abi.ConvertType(out[4], new(*big.Int)).(**big.Int)
	outstruct.InitialBondEth = *abi.ConvertType(out[5], new(*big.Int)).(**big.Int)
	outstruct.DepositTime = *abi.ConvertType(out[6], new(*big.Int)).(**big.Int)
	outstruct.WithdrawnTime = *abi.ConvertType(out[7], new(*big.Int)).(**big.Int)
...
// AddValidatorKeys is a paid mutator transaction binding the contract method 0xe9f432d2.
//
// Solidity: function addValidatorKeys(bytes[] _pubkey, bytes[] _signature) payable returns()
func (_PermissionlessNodeRegistry *PermissionlessNodeRegistryTransactor) AddValidatorKeys(opts *bind.TransactOpts, _pubkey [][]byte, _signature [][]byte) (*types.Transaction, error) {
	return _PermissionlessNodeRegistry.contract.Transact(opts, "addValidatorKeys", _pubkey, _signature)
}

// AddValidatorKeys is a paid mutator transaction binding the contract method 0xe9f432d2.
//
// Solidity: function addValidatorKeys(bytes[] _pubkey, bytes[] _signature) payable returns()
func (_PermissionlessNodeRegistry *PermissionlessNodeRegistrySession) AddValidatorKeys(_pubkey [][]byte, _signature [][]byte) (*types.Transaction, error) {
	return _PermissionlessNodeRegistry.Contract.AddValidatorKeys(&_PermissionlessNodeRegistry.TransactOpts, _pubkey, _signature)
}

// AddValidatorKeys is a paid mutator transaction binding the contract method 0xe9f432d2.
//
// Solidity: function addValidatorKeys(bytes[] _pubkey, bytes[] _signature) payable returns()
func (_PermissionlessNodeRegistry *PermissionlessNodeRegistryTransactorSession) AddValidatorKeys(_pubkey [][]byte, _signature [][]byte) (*types.Transaction, error) {
	return _PermissionlessNodeRegistry.Contract.AddValidatorKeys(&_PermissionlessNodeRegistry.TransactOpts, _pubkey, _signature)
}
...
// SetValidatorDepositTime is a paid mutator transaction binding the contract method 0xaa149161.
//
// Solidity: function setValidatorDepositTime(uint256 _validatorId) returns()
func (_PermissionlessNodeRegistry *PermissionlessNodeRegistryTransactor) SetValidatorDepositTime(opts *bind.TransactOpts, _validatorId *big.Int) (*types.Transaction, error) {
	return _PermissionlessNodeRegistry.contract.Transact(opts, "setValidatorDepositTime", _validatorId)
}

// SetValidatorDepositTime is a paid mutator transaction binding the contract method 0xaa149161.
//
// Solidity: function setValidatorDepositTime(uint256 _validatorId) returns()
func (_PermissionlessNodeRegistry *PermissionlessNodeRegistrySession) SetValidatorDepositTime(_validatorId *big.Int) (*types.Transaction, error) {
	return _PermissionlessNodeRegistry.Contract.SetValidatorDepositTime(&_PermissionlessNodeRegistry.TransactOpts, _validatorId)
}

// SetValidatorDepositTime is a paid mutator transaction binding the contract method 0xaa149161.
//
// Solidity: function setValidatorDepositTime(uint256 _validatorId) returns()
func (_PermissionlessNodeRegistry *PermissionlessNodeRegistryTransactorSession) SetValidatorDepositTime(_validatorId *big.Int) (*types.Transaction, error) {
	return _PermissionlessNodeRegistry.Contract.SetValidatorDepositTime(&_PermissionlessNodeRegistry.TransactOpts, _validatorId)
}
