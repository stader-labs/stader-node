...
//
// Solidity: function slashValidatorSD(uint256 _validatorId, uint8 _poolId) returns(uint256 _sdSlashed)
...
//
// Solidity: event SDSlashed(address indexed operator, address indexed auction, uint256 sdToSlash)
