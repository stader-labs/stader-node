...
//
// Solidity: function calculateRewardShare(uint256 _totalRewards) view returns(uint256 _userShare, uint256 _operatorShare, uint256 _protocolShare)
func (_NodeElRewardVault *NodeElRewardVaultCaller) CalculateRewardShare(opts *bind.CallOpts, _totalRewards *big.Int) (struct {
	UserShare     *big.Int
	OperatorShare *big.Int
	ProtocolShare *big.Int
}, error) {
	var out []interface{}
	err := _NodeElRewardVault.contract.Call(opts, &out, "calculateRewardShare", _totalRewards)
...
//
// Solidity: function calculateRewardShare(uint256 _totalRewards) view returns(uint256 _userShare, uint256 _operatorShare, uint256 _protocolShare)
func (_NodeElRewardVault *NodeElRewardVaultSession) CalculateRewardShare(_totalRewards *big.Int) (struct {
	UserShare     *big.Int
	OperatorShare *big.Int
	ProtocolShare *big.Int
}, error) {
	return _NodeElRewardVault.Contract.CalculateRewardShare(&_NodeElRewardVault.CallOpts, _totalRewards)
}

// CalculateRewardShare is a free data retrieval call binding the contract method 0x92f14c66.
//
// Solidity: function calculateRewardShare(uint256 _totalRewards) view returns(uint256 _userShare, uint256 _operatorShare, uint256 _protocolShare)
func (_NodeElRewardVault *NodeElRewardVaultCallerSession) CalculateRewardShare(_totalRewards *big.Int) (struct {
	UserShare     *big.Int
	OperatorShare *big.Int
	ProtocolShare *big.Int
}, error) {
