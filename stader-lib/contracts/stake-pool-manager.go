...
// DepositedPooledETH is a free data retrieval call binding the contract method 0x82b13ca0.
//
// Solidity: function depositedPooledETH() view returns(uint256)
func (_StakePoolManager *StakePoolManagerCaller) DepositedPooledETH(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _StakePoolManager.contract.Call(opts, &out, "depositedPooledETH")
...
//
// Solidity: function depositedPooledETH() view returns(uint256)
func (_StakePoolManager *StakePoolManagerSession) DepositedPooledETH() (*big.Int, error) {
	return _StakePoolManager.Contract.DepositedPooledETH(&_StakePoolManager.CallOpts)
}

// DepositedPooledETH is a free data retrieval call binding the contract method 0x82b13ca0.
//
// Solidity: function depositedPooledETH() view returns(uint256)
func (_StakePoolManager *StakePoolManagerCallerSession) DepositedPooledETH() (*big.Int, error) {
	return _StakePoolManager.Contract.DepositedPooledETH(&_StakePoolManager.CallOpts)
}
