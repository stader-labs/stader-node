...
// HandleRewards is a paid mutator transaction binding the contract method 0x38a56425.
//
// Solidity: function handleRewards((uint256,uint256,bytes32,uint256,uint256,uint256,uint256) _rewardsData) returns()
