...
func (_SocializingPool *SocializingPoolCaller) STADERORACLE(opts *bind.CallOpts) ([32]byte, error) {
	var out []interface{}
	err := _SocializingPool.contract.Call(opts, &out, "STADER_ORACLE")
...
//
// Solidity: function STADER_ORACLE() view returns(bytes32)
func (_SocializingPool *SocializingPoolSession) STADERORACLE() ([32]byte, error) {
	return _SocializingPool.Contract.STADERORACLE(&_SocializingPool.CallOpts)
}

// STADERORACLE is a free data retrieval call binding the contract method 0x3871d0f1.
//
// Solidity: function STADER_ORACLE() view returns(bytes32)
func (_SocializingPool *SocializingPoolCallerSession) STADERORACLE() ([32]byte, error) {
	return _SocializingPool.Contract.STADERORACLE(&_SocializingPool.CallOpts)
}
...
// TotalELRewardsCollected is a free data retrieval call binding the contract method 0x77c691ee.
//
// Solidity: function totalELRewardsCollected() view returns(uint256)
func (_SocializingPool *SocializingPoolCaller) TotalELRewardsCollected(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _SocializingPool.contract.Call(opts, &out, "totalELRewardsCollected")
...
//
// Solidity: function totalELRewardsCollected() view returns(uint256)
func (_SocializingPool *SocializingPoolSession) TotalELRewardsCollected() (*big.Int, error) {
	return _SocializingPool.Contract.TotalELRewardsCollected(&_SocializingPool.CallOpts)
}

// TotalELRewardsCollected is a free data retrieval call binding the contract method 0x77c691ee.
//
// Solidity: function totalELRewardsCollected() view returns(uint256)
func (_SocializingPool *SocializingPoolCallerSession) TotalELRewardsCollected() (*big.Int, error) {
	return _SocializingPool.Contract.TotalELRewardsCollected(&_SocializingPool.CallOpts)
}
...
func (_SocializingPool *SocializingPoolTransactor) Initialize(opts *bind.TransactOpts, _staderConfig common.Address) (*types.Transaction, error) {
	return _SocializingPool.contract.Transact(opts, "initialize", _staderConfig)
}

// Initialize is a paid mutator transaction binding the contract method 0xc4d66de8.
//
// Solidity: function initialize(address _staderConfig) returns()
func (_SocializingPool *SocializingPoolSession) Initialize(_staderConfig common.Address) (*types.Transaction, error) {
	return _SocializingPool.Contract.Initialize(&_SocializingPool.TransactOpts, _staderConfig)
}

// Initialize is a paid mutator transaction binding the contract method 0xc4d66de8.
//
// Solidity: function initialize(address _staderConfig) returns()
func (_SocializingPool *SocializingPoolTransactorSession) Initialize(_staderConfig common.Address) (*types.Transaction, error) {
	return _SocializingPool.Contract.Initialize(&_SocializingPool.TransactOpts, _staderConfig)
}
