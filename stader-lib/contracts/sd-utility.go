...
func (_SDUtilityPool *SDUtilityPoolCaller) MAXUTILIZATIONRATEPERBLOCK(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _SDUtilityPool.contract.Call(opts, &out, "MAX_UTILIZATION_RATE_PER_BLOCK")
...
func (_SDUtilityPool *SDUtilityPoolSession) MAXUTILIZATIONRATEPERBLOCK() (*big.Int, error) {
	return _SDUtilityPool.Contract.MAXUTILIZATIONRATEPERBLOCK(&_SDUtilityPool.CallOpts)
}
...
func (_SDUtilityPool *SDUtilityPoolCaller) MINSDDELEGATELIMIT(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _SDUtilityPool.contract.Call(opts, &out, "MIN_SD_DELEGATE_LIMIT")
...
func (_SDUtilityPool *SDUtilityPoolSession) MINSDDELEGATELIMIT() (*big.Int, error) {
	return _SDUtilityPool.Contract.MINSDDELEGATELIMIT(&_SDUtilityPool.CallOpts)
}
...
func (_SDUtilityPool *SDUtilityPoolCaller) MINSDWITHDRAWLIMIT(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _SDUtilityPool.contract.Call(opts, &out, "MIN_SD_WITHDRAW_LIMIT")
...
func (_SDUtilityPool *SDUtilityPoolSession) MINSDWITHDRAWLIMIT() (*big.Int, error) {
	return _SDUtilityPool.Contract.MINSDWITHDRAWLIMIT(&_SDUtilityPool.CallOpts)
}
...
func (_SDUtilityPool *SDUtilityPoolCaller) ConservativeEthPerKey(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _SDUtilityPool.contract.Call(opts, &out, "conservativeEthPerKey")
...
func (_SDUtilityPool *SDUtilityPoolSession) ConservativeEthPerKey() (*big.Int, error) {
	return _SDUtilityPool.Contract.ConservativeEthPerKey(&_SDUtilityPool.CallOpts)
}
...
func (_SDUtilityPool *SDUtilityPoolCaller) ProtocolFee(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _SDUtilityPool.contract.Call(opts, &out, "protocolFee")
...
func (_SDUtilityPool *SDUtilityPoolSession) ProtocolFee() (*big.Int, error) {
	return _SDUtilityPool.Contract.ProtocolFee(&_SDUtilityPool.CallOpts)
}
...
func (_SDUtilityPool *SDUtilityPoolTransactor) ClearUtilizerInterest(opts *bind.TransactOpts, _utilizer common.Address) (*types.Transaction, error) {
	return _SDUtilityPool.contract.Transact(opts, "clearUtilizerInterest", _utilizer)
}
...
func (_SDUtilityPool *SDUtilityPoolSession) ClearUtilizerInterest(_utilizer common.Address) (*types.Transaction, error) {
	return _SDUtilityPool.Contract.ClearUtilizerInterest(&_SDUtilityPool.TransactOpts, _utilizer)
}
...
func (_SDUtilityPool *SDUtilityPoolTransactor) RepayFullAmount(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _SDUtilityPool.contract.Transact(opts, "repayFullAmount")
}
...
func (_SDUtilityPool *SDUtilityPoolSession) RepayFullAmount() (*types.Transaction, error) {
	return _SDUtilityPool.Contract.RepayFullAmount(&_SDUtilityPool.TransactOpts)
}
...
func (_SDUtilityPool *SDUtilityPoolTransactor) RepayUtilizedSDBalance(opts *bind.TransactOpts, _utilizer common.Address, amount *big.Int) (*types.Transaction, error) {
	return _SDUtilityPool.contract.Transact(opts, "repayUtilizedSDBalance", _utilizer, amount)
}
...
func (_SDUtilityPool *SDUtilityPoolSession) RepayUtilizedSDBalance(_utilizer common.Address, amount *big.Int) (*types.Transaction, error) {
	return _SDUtilityPool.Contract.RepayUtilizedSDBalance(&_SDUtilityPool.TransactOpts, _utilizer, amount)
}
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *SDUtilityPoolClearedUtilizerInterestIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(SDUtilityPoolClearedUtilizerInterest)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *SDUtilityPoolClearedUtilizerInterestIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *SDUtilityPoolClearedUtilizerInterestIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}
...
func (_SDUtilityPool *SDUtilityPoolFilterer) FilterClearedUtilizerInterest(opts *bind.FilterOpts, utilizer []common.Address) (*SDUtilityPoolClearedUtilizerInterestIterator, error) {
	...
	logs, sub, err := _SDUtilityPool.contract.FilterLogs(opts, "ClearedUtilizerInterest", utilizerRule)
	if err != nil {
		return nil, err
	}
	return &SDUtilityPoolClearedUtilizerInterestIterator{contract: _SDUtilityPool.contract, event: "ClearedUtilizerInterest", logs: logs, sub: sub}, nil
}
...
func (_SDUtilityPool *SDUtilityPoolFilterer) WatchClearedUtilizerInterest(opts *bind.WatchOpts, sink chan<- *SDUtilityPoolClearedUtilizerInterest, utilizer []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _SDUtilityPool.contract.WatchLogs(opts, "ClearedUtilizerInterest", utilizerRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(SDUtilityPoolClearedUtilizerInterest)
				if err := _SDUtilityPool.contract.UnpackLog(event, "ClearedUtilizerInterest", log); err != nil {
					return err
				}
				event.Raw = log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *SDUtilityPoolRepaidUtilizedSDBalanceIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(SDUtilityPoolRepaidUtilizedSDBalance)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *SDUtilityPoolRepaidUtilizedSDBalanceIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *SDUtilityPoolRepaidUtilizedSDBalanceIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}
...
func (_SDUtilityPool *SDUtilityPoolFilterer) FilterRepaidUtilizedSDBalance(opts *bind.FilterOpts, utilizer []common.Address) (*SDUtilityPoolRepaidUtilizedSDBalanceIterator, error) {
	...
	logs, sub, err := _SDUtilityPool.contract.FilterLogs(opts, "RepaidUtilizedSDBalance", utilizerRule)
	if err != nil {
		return nil, err
	}
	return &SDUtilityPoolRepaidUtilizedSDBalanceIterator{contract: _SDUtilityPool.contract, event: "RepaidUtilizedSDBalance", logs: logs, sub: sub}, nil
}
...
func (_SDUtilityPool *SDUtilityPoolFilterer) WatchRepaidUtilizedSDBalance(opts *bind.WatchOpts, sink chan<- *SDUtilityPoolRepaidUtilizedSDBalance, utilizer []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _SDUtilityPool.contract.WatchLogs(opts, "RepaidUtilizedSDBalance", utilizerRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(SDUtilityPoolRepaidUtilizedSDBalance)
				if err := _SDUtilityPool.contract.UnpackLog(event, "RepaidUtilizedSDBalance", log); err != nil {
					return err
				}
				event.Raw = log
