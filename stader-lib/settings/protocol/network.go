...
func BootstrapNodeConsensusThreshold(rp *stader.PermissionlessNodeRegistryContractManager, value float64, opts *bind.TransactOpts) (common.Hash, error) {
...
func BootstrapSubmitBalancesEnabled(rp *stader.PermissionlessNodeRegistryContractManager, value bool, opts *bind.TransactOpts) (common.Hash, error) {
...
func BootstrapSubmitBalancesFrequency(rp *stader.PermissionlessNodeRegistryContractManager, value uint64, opts *bind.TransactOpts) (common.Hash, error) {
...
func BootstrapSubmitPricesEnabled(rp *stader.PermissionlessNodeRegistryContractManager, value bool, opts *bind.TransactOpts) (common.Hash, error) {
...
func BootstrapSubmitPricesFrequency(rp *stader.PermissionlessNodeRegistryContractManager, value uint64, opts *bind.TransactOpts) (common.Hash, error) {
...
func GetMinimumNodeFee(rp *stader.PermissionlessNodeRegistryContractManager, opts *bind.CallOpts) (float64, error) {
	networkSettingsContract, err := getNetworkSettingsContract(rp, opts)
	if err != nil {
		return 0, err
	}
...
func BootstrapMinimumNodeFee(rp *stader.PermissionlessNodeRegistryContractManager, value float64, opts *bind.TransactOpts) (common.Hash, error) {
...
func GetTargetNodeFee(rp *stader.PermissionlessNodeRegistryContractManager, opts *bind.CallOpts) (float64, error) {
	networkSettingsContract, err := getNetworkSettingsContract(rp, opts)
	if err != nil {
		return 0, err
	}
...
func BootstrapTargetNodeFee(rp *stader.PermissionlessNodeRegistryContractManager, value float64, opts *bind.TransactOpts) (common.Hash, error) {
...
func GetMaximumNodeFee(rp *stader.PermissionlessNodeRegistryContractManager, opts *bind.CallOpts) (float64, error) {
	networkSettingsContract, err := getNetworkSettingsContract(rp, opts)
	if err != nil {
		return 0, err
	}
...
func BootstrapMaximumNodeFee(rp *stader.PermissionlessNodeRegistryContractManager, value float64, opts *bind.TransactOpts) (common.Hash, error) {
...
func BootstrapNodeFeeDemandRange(rp *stader.PermissionlessNodeRegistryContractManager, value *big.Int, opts *bind.TransactOpts) (common.Hash, error) {
...
func BootstrapTargetRethCollateralRate(rp *stader.PermissionlessNodeRegistryContractManager, value float64, opts *bind.TransactOpts) (common.Hash, error) {
...
func getNetworkSettingsContract(rp *stader.PermissionlessNodeRegistryContractManager, opts *bind.CallOpts) (*stader.Contract, error) {
