...
func FilterContractLogs(rp *stader.PermissionlessNodeRegistryContractManager, contractName string, q FilterQuery, intervalSize *big.Int, opts *bind.CallOpts) ([]types.Log, error) {
...
func GetLogs(rp *stader.PermissionlessNodeRegistryContractManager, addressFilter []common.Address, topicFilter [][]common.Hash, intervalSize, fromBlock, toBlock *big.Int, blockHash *common.Hash) ([]types.Log, error) {
	var logs []types.Log
