...
import (
	...
	"github.com/stader-labs/stader-minipool-go/network"
...
// Create a minipool
func CreateMinipool(t *testing.T, rp *stader.EthxContractManager, ownerAccount, nodeAccount *accounts.Account, depositAmount *big.Int, pubkey int) (*minipool.Minipool, error) {
...
// Stake a minipool
func StakeMinipool(rp *stader.EthxContractManager, mp *minipool.Minipool, nodeAccount *accounts.Account) error {
...
func GetMinipoolRPLRequired(rp *stader.EthxContractManager) (*big.Int, error) {
