...
//func Deposit(t *testing.T, rp *stader.EthxContractManager, nodeAccount *accounts.Account, depositAmount *big.Int, pubkey int) (common.Address, *types.Receipt, error) {
//
//	// Get the next salt
//	salt := GetSalt()
//	//
