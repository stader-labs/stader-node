...
func MintRPL(rp *stader.EthxContractManager, ownerAccount *accounts.Account, toAccount *accounts.Account, amount *big.Int) error {
...
func MintFixedSupplyRPL(rp *stader.EthxContractManager, ownerAccount *accounts.Account, toAccount *accounts.Account, amount *big.Int) error {
