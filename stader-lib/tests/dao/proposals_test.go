...
import (
	...
	"github.com/stader-labs/stader-minipool-go/dao"
	...
	rptypes "github.com/stader-labs/stader-minipool-go/types"
...
func TestProposalDetails(t *testing.T) {
	...
	proposalMemberEmail := "coolguy@stader.net"
	...
	cancelledProposalId, _, err := trustednodedao.ProposeInviteMember(rp, "cancel this", nodeAccount.Address, "cancel", "cancel@stader.net", trustedNodeAccount1.GetTransactor())
	if err != nil {
		t.Fatal(err)
	}
