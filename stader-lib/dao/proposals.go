...
func GetProposals(rp *stader.PermissionlessNodeRegistryContractManager, opts *bind.CallOpts) ([]ProposalDetails, error) {
...
func GetProposalsWithMember(rp *stader.PermissionlessNodeRegistryContractManager, memberAddress common.Address, opts *bind.CallOpts) ([]ProposalDetails, error) {
...
func GetDAOProposals(rp *stader.PermissionlessNodeRegistryContractManager, daoName string, opts *bind.CallOpts) ([]ProposalDetails, error) {
...
func GetDAOProposalsWithMember(rp *stader.PermissionlessNodeRegistryContractManager, daoName string, memberAddress common.Address, opts *bind.CallOpts) ([]ProposalDetails, error) {
...
func GetDAOProposalIDs(rp *stader.PermissionlessNodeRegistryContractManager, daoName string, opts *bind.CallOpts) ([]uint64, error) {
...
func GetProposalDetails(rp *stader.PermissionlessNodeRegistryContractManager, proposalId uint64, opts *bind.CallOpts) (ProposalDetails, error) {
...
func GetProposalDetailsWithMember(rp *stader.PermissionlessNodeRegistryContractManager, proposalId uint64, memberAddress common.Address, opts *bind.CallOpts) (ProposalDetails, error) {
...
func GetProposalCount(rp *stader.PermissionlessNodeRegistryContractManager, opts *bind.CallOpts) (uint64, error) {
...
// Proposal details
func GetProposalDAO(rp *stader.PermissionlessNodeRegistryContractManager, proposalId uint64, opts *bind.CallOpts) (string, error) {
	rocketDAOProposal, err := getRocketDAOProposal(rp, opts)
	if err != nil {
		return "", err
	}
...
func GetProposalProposerAddress(rp *stader.PermissionlessNodeRegistryContractManager, proposalId uint64, opts *bind.CallOpts) (common.Address, error) {
	rocketDAOProposal, err := getRocketDAOProposal(rp, opts)
	if err != nil {
...
func GetProposalMessage(rp *stader.PermissionlessNodeRegistryContractManager, proposalId uint64, opts *bind.CallOpts) (string, error) {
	rocketDAOProposal, err := getRocketDAOProposal(rp, opts)
	if err != nil {
		return "", err
	}
...
func GetProposalCreatedTime(rp *stader.PermissionlessNodeRegistryContractManager, proposalId uint64, opts *bind.CallOpts) (uint64, error) {
	rocketDAOProposal, err := getRocketDAOProposal(rp, opts)
	if err != nil {
		return 0, err
	}
...
func GetProposalStartTime(rp *stader.PermissionlessNodeRegistryContractManager, proposalId uint64, opts *bind.CallOpts) (uint64, error) {
	rocketDAOProposal, err := getRocketDAOProposal(rp, opts)
	if err != nil {
		return 0, err
	}
...
func GetProposalEndTime(rp *stader.PermissionlessNodeRegistryContractManager, proposalId uint64, opts *bind.CallOpts) (uint64, error) {
	rocketDAOProposal, err := getRocketDAOProposal(rp, opts)
	if err != nil {
		return 0, err
	}
...
func GetProposalExpiryTime(rp *stader.PermissionlessNodeRegistryContractManager, proposalId uint64, opts *bind.CallOpts) (uint64, error) {
	rocketDAOProposal, err := getRocketDAOProposal(rp, opts)
	if err != nil {
		return 0, err
	}
...
func GetProposalVotesRequired(rp *stader.PermissionlessNodeRegistryContractManager, proposalId uint64, opts *bind.CallOpts) (float64, error) {
	rocketDAOProposal, err := getRocketDAOProposal(rp, opts)
	if err != nil {
		return 0, err
	}
...
func GetProposalVotesFor(rp *stader.PermissionlessNodeRegistryContractManager, proposalId uint64, opts *bind.CallOpts) (float64, error) {
	rocketDAOProposal, err := getRocketDAOProposal(rp, opts)
	if err != nil {
		return 0, err
	}
...
func GetProposalVotesAgainst(rp *stader.PermissionlessNodeRegistryContractManager, proposalId uint64, opts *bind.CallOpts) (float64, error) {
	rocketDAOProposal, err := getRocketDAOProposal(rp, opts)
	if err != nil {
		return 0, err
	}
...
func GetProposalIsCancelled(rp *stader.PermissionlessNodeRegistryContractManager, proposalId uint64, opts *bind.CallOpts) (bool, error) {
	rocketDAOProposal, err := getRocketDAOProposal(rp, opts)
	if err != nil {
		return false, err
	}
...
func GetProposalIsExecuted(rp *stader.PermissionlessNodeRegistryContractManager, proposalId uint64, opts *bind.CallOpts) (bool, error) {
	rocketDAOProposal, err := getRocketDAOProposal(rp, opts)
	if err != nil {
		return false, err
	}
...
func GetProposalPayload(rp *stader.PermissionlessNodeRegistryContractManager, proposalId uint64, opts *bind.CallOpts) ([]byte, error) {
	rocketDAOProposal, err := getRocketDAOProposal(rp, opts)
	if err != nil {
		return []byte{}, err
	}
...
func GetProposalPayloadStr(rp *stader.PermissionlessNodeRegistryContractManager, proposalId uint64, opts *bind.CallOpts) (string, error) {
	dao, err := GetProposalDAO(rp, proposalId, opts)
	if err != nil {
		return "", err
	}
...
func GetProposalState(rp *stader.PermissionlessNodeRegistryContractManager, proposalId uint64, opts *bind.CallOpts) (rptypes.ProposalState, error) {
	rocketDAOProposal, err := getRocketDAOProposal(rp, opts)
	if err != nil {
		return 0, err
	}
...
func GetProposalMemberVoted(rp *stader.PermissionlessNodeRegistryContractManager, proposalId uint64, memberAddress common.Address, opts *bind.CallOpts) (bool, error) {
	rocketDAOProposal, err := getRocketDAOProposal(rp, opts)
	if err != nil {
		return false, err
	}
...
func GetProposalMemberSupported(rp *stader.PermissionlessNodeRegistryContractManager, proposalId uint64, memberAddress common.Address, opts *bind.CallOpts) (bool, error) {
	rocketDAOProposal, err := getRocketDAOProposal(rp, opts)
	if err != nil {
		return false, err
	}
...
func getRocketDAOProposal(rp *stader.PermissionlessNodeRegistryContractManager, opts *bind.CallOpts) (*stader.Contract, error) {
