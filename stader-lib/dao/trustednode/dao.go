...
func GetMembers(rp *stader.PermissionlessNodeRegistryContractManager, opts *bind.CallOpts) ([]MemberDetails, error) {
...
func GetMemberAddresses(rp *stader.PermissionlessNodeRegistryContractManager, opts *bind.CallOpts) ([]common.Address, error) {
...
func GetMemberDetails(rp *stader.PermissionlessNodeRegistryContractManager, memberAddress common.Address, opts *bind.CallOpts) (MemberDetails, error) {
...
func GetMinimumMemberCount(rp *stader.PermissionlessNodeRegistryContractManager, opts *bind.CallOpts) (uint64, error) {
...
func GetMemberCount(rp *stader.PermissionlessNodeRegistryContractManager, opts *bind.CallOpts) (uint64, error) {
	rocketDAONodeTrusted, err := getRocketDAONodeTrusted(rp, opts)
	if err != nil {
		return 0, err
	}
...
func GetMemberAt(rp *stader.PermissionlessNodeRegistryContractManager, index uint64, opts *bind.CallOpts) (common.Address, error) {
	rocketDAONodeTrusted, err := getRocketDAONodeTrusted(rp, opts)
	if err != nil {
		return common.Address{}, err
	}
...
// Member details
func GetMemberExists(rp *stader.PermissionlessNodeRegistryContractManager, memberAddress common.Address, opts *bind.CallOpts) (bool, error) {
	rocketDAONodeTrusted, err := getRocketDAONodeTrusted(rp, opts)
	if err != nil {
		return false, err
	}
...
func GetMemberID(rp *stader.PermissionlessNodeRegistryContractManager, memberAddress common.Address, opts *bind.CallOpts) (string, error) {
	rocketDAONodeTrusted, err := getRocketDAONodeTrusted(rp, opts)
	if err != nil {
		return "", err
	}
...
func GetMemberUrl(rp *stader.PermissionlessNodeRegistryContractManager, memberAddress common.Address, opts *bind.CallOpts) (string, error) {
	rocketDAONodeTrusted, err := getRocketDAONodeTrusted(rp, opts)
	if err != nil {
		return "", err
	}
...
func GetMemberJoinedTime(rp *stader.PermissionlessNodeRegistryContractManager, memberAddress common.Address, opts *bind.CallOpts) (uint64, error) {
	rocketDAONodeTrusted, err := getRocketDAONodeTrusted(rp, opts)
	if err != nil {
		return 0, err
	}
...
func GetMemberLastProposalTime(rp *stader.PermissionlessNodeRegistryContractManager, memberAddress common.Address, opts *bind.CallOpts) (uint64, error) {
	rocketDAONodeTrusted, err := getRocketDAONodeTrusted(rp, opts)
	if err != nil {
		return 0, err
	}
...
func GetMemberRPLBondAmount(rp *stader.PermissionlessNodeRegistryContractManager, memberAddress common.Address, opts *bind.CallOpts) (*big.Int, error) {
	rocketDAONodeTrusted, err := getRocketDAONodeTrusted(rp, opts)
	if err != nil {
		return nil, err
	}
...
func GetMemberUnbondedValidatorCount(rp *stader.PermissionlessNodeRegistryContractManager, memberAddress common.Address, opts *bind.CallOpts) (uint64, error) {
	rocketDAONodeTrusted, err := getRocketDAONodeTrusted(rp, opts)
	if err != nil {
		return 0, err
	}
...
func GetMemberInviteProposalExecutedTime(rp *stader.PermissionlessNodeRegistryContractManager, memberAddress common.Address, opts *bind.CallOpts) (uint64, error) {
	return GetMemberProposalExecutedTime(rp, "invited", memberAddress, opts)
}
func GetMemberLeaveProposalExecutedTime(rp *stader.PermissionlessNodeRegistryContractManager, memberAddress common.Address, opts *bind.CallOpts) (uint64, error) {
	return GetMemberProposalExecutedTime(rp, "leave", memberAddress, opts)
}
func GetMemberReplaceProposalExecutedTime(rp *stader.PermissionlessNodeRegistryContractManager, memberAddress common.Address, opts *bind.CallOpts) (uint64, error) {
	return GetMemberProposalExecutedTime(rp, "replace", memberAddress, opts)
}
func GetMemberProposalExecutedTime(rp *stader.PermissionlessNodeRegistryContractManager, proposalType string, memberAddress common.Address, opts *bind.CallOpts) (uint64, error) {
	rocketDAONodeTrusted, err := getRocketDAONodeTrusted(rp, opts)
	if err != nil {
		return 0, err
	}
...
func GetMemberReplacementAddress(rp *stader.PermissionlessNodeRegistryContractManager, memberAddress common.Address, opts *bind.CallOpts) (common.Address, error) {
	rocketDAONodeTrusted, err := getRocketDAONodeTrusted(rp, opts)
	if err != nil {
		return common.Address{}, err
	}
...
func GetMemberIsChallenged(rp *stader.PermissionlessNodeRegistryContractManager, memberAddress common.Address, opts *bind.CallOpts) (bool, error) {
	rocketDAONodeTrusted, err := getRocketDAONodeTrusted(rp, opts)
	if err != nil {
		return false, err
	}
...
func EstimateBootstrapMemberGas(rp *stader.PermissionlessNodeRegistryContractManager, id, url string, nodeAddress common.Address, opts *bind.TransactOpts) (stader.GasInfo, error) {
	rocketDAONodeTrusted, err := getRocketDAONodeTrusted(rp, nil)
	if err != nil {
		return stader.GasInfo{}, err
	}
...
func BootstrapMember(rp *stader.PermissionlessNodeRegistryContractManager, id, url string, nodeAddress common.Address, opts *bind.TransactOpts) (common.Hash, error) {
	rocketDAONodeTrusted, err := getRocketDAONodeTrusted(rp, nil)
	if err != nil {
		return common.Hash{}, err
	}
...
func EstimateBootstrapUpgradeGas(rp *stader.PermissionlessNodeRegistryContractManager, upgradeType, contractName, contractAbi string, contractAddress common.Address, opts *bind.TransactOpts) (stader.GasInfo, error) {
...
func BootstrapUpgrade(rp *stader.PermissionlessNodeRegistryContractManager, upgradeType, contractName, contractAbi string, contractAddress common.Address, opts *bind.TransactOpts) (common.Hash, error) {
	compressedAbi, err := stader.EncodeAbiStr(contractAbi)
	if err != nil {
		return common.Hash{}, err
	}
...
func getRocketDAONodeTrusted(rp *stader.PermissionlessNodeRegistryContractManager, opts *bind.CallOpts) (*stader.Contract, error) {
