...
// Get all lot details
func GetLots(rp *stader.PermissionlessNodeRegistryContractManager, opts *bind.CallOpts) ([]LotDetails, error) {
...
func GetLotsWithBids(rp *stader.PermissionlessNodeRegistryContractManager, bidder common.Address, opts *bind.CallOpts) ([]LotDetails, error) {
...
// Get a lot's details
func GetLotDetails(rp *stader.PermissionlessNodeRegistryContractManager, lotIndex uint64, opts *bind.CallOpts) (LotDetails, error) {
...
func GetLotCount(rp *stader.PermissionlessNodeRegistryContractManager, opts *bind.CallOpts) (uint64, error) {
	rocketAuctionManager, err := getRocketAuctionManager(rp, opts)
	if err != nil {
		return 0, err
	}
...
func GetLotStartBlock(rp *stader.PermissionlessNodeRegistryContractManager, lotIndex uint64, opts *bind.CallOpts) (uint64, error) {
	rocketAuctionManager, err := getRocketAuctionManager(rp, opts)
	if err != nil {
		return 0, err
	}
...
func GetLotEndBlock(rp *stader.PermissionlessNodeRegistryContractManager, lotIndex uint64, opts *bind.CallOpts) (uint64, error) {
	rocketAuctionManager, err := getRocketAuctionManager(rp, opts)
	if err != nil {
		return 0, err
	}
...
func EstimateCreateLotGas(rp *stader.PermissionlessNodeRegistryContractManager, opts *bind.TransactOpts) (stader.GasInfo, error) {
...
// Create a new lot
func CreateLot(rp *stader.PermissionlessNodeRegistryContractManager, opts *bind.TransactOpts) (uint64, common.Hash, error) {
	rocketAuctionManager, err := getRocketAuctionManager(rp, nil)
	if err != nil {
...
func PlaceBid(rp *stader.PermissionlessNodeRegistryContractManager, lotIndex uint64, opts *bind.TransactOpts) (common.Hash, error) {
	rocketAuctionManager, err := getRocketAuctionManager(rp, nil)
	if err != nil {
...
func ClaimBid(rp *stader.PermissionlessNodeRegistryContractManager, lotIndex uint64, opts *bind.TransactOpts) (common.Hash, error) {
	rocketAuctionManager, err := getRocketAuctionManager(rp, nil)
	if err != nil {
		return common.Hash{}, err
	}
...
func getRocketAuctionManager(rp *stader.PermissionlessNodeRegistryContractManager, opts *bind.CallOpts) (*stader.Contract, error) {
