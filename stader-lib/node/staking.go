...
//func GetTotalRPLStake(rp *stader.EthxContractManager, opts *bind.CallOpts) (*big.Int, error) {
...
//func GetTotalEffectiveRPLStake(rp *stader.EthxContractManager, opts *bind.CallOpts) (*big.Int, error) {
//	rocketNodeStaking, err := getRocketNodeStaking(rp, opts)
//	if err != nil {
//		return nil, err
//	}
...
//func GetNodeRPLStake(rp *stader.EthxContractManager, nodeAddress common.Address, opts *bind.CallOpts) (*big.Int, error) {
//	rocketNodeStaking, err := getRocketNodeStaking(rp, opts)
//	if err != nil {
//		return nil, err
//	}
...
//func GetNodeEffectiveRPLStake(rp *stader.EthxContractManager, nodeAddress common.Address, opts *bind.CallOpts) (*big.Int, error) {
//	rocketNodeStaking, err := getRocketNodeStaking(rp, opts)
//	if err != nil {
//		return nil, err
//	}
...
//func GetNodeMinimumRPLStake(rp *stader.EthxContractManager, nodeAddress common.Address, opts *bind.CallOpts) (*big.Int, error) {
//	rocketNodeStaking, err := getRocketNodeStaking(rp, opts)
//	if err != nil {
//		return nil, err
//	}
...
//func GetNodeMaximumRPLStake(rp *stader.EthxContractManager, nodeAddress common.Address, opts *bind.CallOpts) (*big.Int, error) {
//	rocketNodeStaking, err := getRocketNodeStaking(rp, opts)
//	if err != nil {
//		return nil, err
//	}
...
//func GetNodeRPLStakedTime(rp *stader.EthxContractManager, nodeAddress common.Address, opts *bind.CallOpts) (uint64, error) {
//	rocketNodeStaking, err := getRocketNodeStaking(rp, opts)
//	if err != nil {
//		return 0, err
//	}
...
//func GetNodeMinipoolLimit(rp *stader.EthxContractManager, nodeAddress common.Address, opts *bind.CallOpts) (uint64, error) {
//	rocketNodeStaking, err := getRocketNodeStaking(rp, opts)
//	if err != nil {
//		return 0, err
//	}
...
//func EstimateStakeGas(rp *stader.EthxContractManager, rplAmount *big.Int, opts *bind.TransactOpts) (stader.GasInfo, error) {
...
//
//// Stake RPL
//func StakeRPL(rp *stader.EthxContractManager, rplAmount *big.Int, opts *bind.TransactOpts) (common.Hash, error) {
//	rocketNodeStaking, err := getRocketNodeStaking(rp, nil)
//	if err != nil {
...
//func EstimateWithdrawRPLGas(rp *stader.EthxContractManager, rplAmount *big.Int, opts *bind.TransactOpts) (stader.GasInfo, error) {
//	rocketNodeStaking, err := getRocketNodeStaking(rp, nil)
//	if err != nil {
//		return stader.GasInfo{}, err
//	}
...
//
//// Withdraw staked RPL
//func WithdrawRPL(rp *stader.EthxContractManager, rplAmount *big.Int, opts *bind.TransactOpts) (common.Hash, error) {
//	rocketNodeStaking, err := getRocketNodeStaking(rp, nil)
//	if err != nil {
//		return common.Hash{}, err
//	}
...
//func CalculateTotalEffectiveRPLStake(rp *stader.EthxContractManager, offset, limit, rplPrice *big.Int, opts *bind.CallOpts) (*big.Int, error) {
//	rocketNodeStaking, err := getRocketNodeStaking(rp, opts)
//	if err != nil {
//		return nil, err
//	}
...
//
//func getRocketNodeStaking(rp *stader.EthxContractManager, opts *bind.CallOpts) (*stader.Contract, error) {
