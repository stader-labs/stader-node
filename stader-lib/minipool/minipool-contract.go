...
type Minipool struct {
	...
	RocketPool *stader.PermissionlessNodeRegistryContractManager
}

// Create new minipool contract
func NewMinipool(rp *stader.PermissionlessNodeRegistryContractManager, address common.Address, opts *bind.CallOpts) (*Minipool, error) {
...
func (mp *Minipool) EstimateRefundGas(opts *bind.TransactOpts) (stader.GasInfo, error) {
...
func (mp *Minipool) EstimateDistributeBalanceGas(opts *bind.TransactOpts) (stader.GasInfo, error) {
...
func (mp *Minipool) EstimateDistributeBalanceAndFinaliseGas(opts *bind.TransactOpts) (stader.GasInfo, error) {
...
func (mp *Minipool) EstimateStakeGas(validatorSignature rptypes.ValidatorSignature, depositDataRoot common.Hash, opts *bind.TransactOpts) (stader.GasInfo, error) {
...
func (mp *Minipool) EstimateDissolveGas(opts *bind.TransactOpts) (stader.GasInfo, error) {
...
func (mp *Minipool) EstimateCloseGas(opts *bind.TransactOpts) (stader.GasInfo, error) {
...
func (mp *Minipool) EstimateFinaliseGas(opts *bind.TransactOpts) (stader.GasInfo, error) {
...
func (mp *Minipool) EstimateDelegateUpgradeGas(opts *bind.TransactOpts) (stader.GasInfo, error) {
...
func (mp *Minipool) EstimateDelegateRollbackGas(opts *bind.TransactOpts) (stader.GasInfo, error) {
...
func (mp *Minipool) EstimateSetUseLatestDelegateGas(setting bool, opts *bind.TransactOpts) (stader.GasInfo, error) {
...
func (mp *Minipool) EstimateVoteScrubGas(opts *bind.TransactOpts) (stader.GasInfo, error) {
...
func getMinipoolContract(rp *stader.PermissionlessNodeRegistryContractManager, minipoolAddress common.Address, opts *bind.CallOpts) (*stader.Contract, error) {
