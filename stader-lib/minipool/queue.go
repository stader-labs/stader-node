...
import (
	...
	"github.com/stader-labs/stader-node/stader-lib/storage"
...
func GetQueueLengths(rp *stader.PermissionlessNodeRegistryContractManager, opts *bind.CallOpts) (QueueLengths, error) {
...
func GetQueueCapacity(rp *stader.PermissionlessNodeRegistryContractManager, opts *bind.CallOpts) (QueueCapacity, error) {
...
func GetQueueTotalLength(rp *stader.PermissionlessNodeRegistryContractManager, opts *bind.CallOpts) (uint64, error) {
...
func GetQueueLength(rp *stader.PermissionlessNodeRegistryContractManager, depositType rptypes.MinipoolDeposit, opts *bind.CallOpts) (uint64, error) {
	rocketMinipoolQueue, err := getRocketMinipoolQueue(rp, opts)
	if err != nil {
		return 0, err
	}
...
func GetQueueTotalCapacity(rp *stader.PermissionlessNodeRegistryContractManager, opts *bind.CallOpts) (*big.Int, error) {
	rocketMinipoolQueue, err := getRocketMinipoolQueue(rp, opts)
	if err != nil {
		return nil, err
	}
...
func GetQueueEffectiveCapacity(rp *stader.PermissionlessNodeRegistryContractManager, opts *bind.CallOpts) (*big.Int, error) {
	rocketMinipoolQueue, err := getRocketMinipoolQueue(rp, opts)
	if err != nil {
		return nil, err
	}
...
func GetQueueNextCapacity(rp *stader.PermissionlessNodeRegistryContractManager, opts *bind.CallOpts) (*big.Int, error) {
	rocketMinipoolQueue, err := getRocketMinipoolQueue(rp, opts)
	if err != nil {
		return nil, err
	}
...
func GetQueueDetails(rp *stader.PermissionlessNodeRegistryContractManager, mp *Minipool, opts *bind.CallOpts) (QueueDetails, error) {
...
func GetQueueMinipoolAtPosition(rp *stader.PermissionlessNodeRegistryContractManager, position uint64, opts *bind.CallOpts) (*Minipool, error) {
...
func getRocketMinipoolQueue(rp *stader.PermissionlessNodeRegistryContractManager, opts *bind.CallOpts) (*stader.Contract, error) {
