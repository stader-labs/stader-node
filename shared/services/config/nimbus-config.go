...
const (
	// Testnet
	nimbusBnTagTest string = "statusim/nimbus-eth2:multiarch-v24.8.0"
	nimbusVcTagTest string = "statusim/nimbus-validator-client:multiarch-v24.8.0"

	// Mainnet
	nimbusBnTagProd string = "statusim/nimbus-eth2:multiarch-v24.8.0"
	nimbusVcTagProd string = "statusim/nimbus-validator-client:multiarch-v24.8.0"
