...
const (
	...
	prysmVcTagAmd64Test     string = "prysmaticlabs/prysm-beacon-chain:HEAD-f4681f-debug"
	prysmTagArm64Test       string = "prysmaticlabs/prysm-beacon-chain:HEAD-f4681f-debug"
	prysmBnTagAmd64Prod     string = "prysmaticlabs/prysm-beacon-chain:HEAD-f4681f-debug"
	prysmVcTagAmd64Prod     string = "prysmaticlabs/prysm-beacon-chain:HEAD-f4681f-debug"
	prysmTagArm64Prod       string = "prysmaticlabs/prysm-beacon-chain:HEAD-f4681f-debug"
