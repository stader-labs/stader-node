...
const (
	prysmBnTagTest string = "staderdev/prysm:v4.2.1-rc.0"
	prysmVcTagTest string = "staderdev/prysm:v4.2.1-rc.0"

	prysmBnTagProd string = "staderdev/prysm:v4.2.0"
	prysmVcTagProd string = "staderdev/prysm:v4.2.0"
